<?php
/**
 * WXR importer class used in the Mirrorgrid Demo Importer plugin.
 * Needed to extend the MG_Importer_WXR_Importer class to get/set the importer protected variables,
 * for use in the multiple AJAX calls.
 *
 * @package mg
 */

class MG_WXR_Importer extends MG_Importer_WXR_Importer {
	...
	/**
	 * Get all protected variables from the MG_Importer_WXR_Importer needed for continuing the import.
	 */
	...
	/**
	 * Sets all protected variables from the MG_Importer_WXR_Importer needed for continuing the import.
	 *
